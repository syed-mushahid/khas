...
<div class=" section">
    ...
    <div class="col-lg-8   col-md-10  col-12">
      ...
      <form class="card shadow-lg rounded-3 border-0  login-form mt-5 mb-5 needs-validation" action="{{ url('signup') }}" method="POST" novalidate>
        @csrf
        <div class="card-body ">
    ...
    <div class="col-lg-4 col-md-4 col-12"><a class="btn google-btn" href="{{route('login.google')}}"><i class="fa-brands fa-google"></i> Google</a>
    </div>
    </div>
    </div>
  ...
  <div class="row">
    ...
    <a class="lost-pass" href="{{route('password.forgot')}}">Forgot password?</a>
    </div>
    <div class="button">
