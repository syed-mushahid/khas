   ...
   <div class="container">
      <div class="row justify-content-center">
         <div class="py-3 shadow-lg rounded-4 px-4 col-md-8 ">
            ...
            <form action="{{route('phones.create')}}" method="post" enctype='multipart/form-data'>
               @csrf
               @if($errors->any())
           ...
           <div class="mb-3 col-12 pb-2">
            ...
            <input class="form-control" type="text" name="title" id="title" value="{{ isset($phone) ? $phone->title : old('title') }}">
          </div>
               <div class="row">
                ...
                <div class="mb-3 col-sm-6 pb-2">
                  ...
                  <input class="form-control" type="number" step="0.01" name="price" id="price" value="{{ isset($phone) ? $phone->price : old('price') }}">
                </div>
                <div class="mb-3 col-sm-6 pb-2">
                  <label class="form-label" for="color">Color</label>
                  <input class="form-control" type="text" name="color" id="color" value="{{ isset($phone) ? $phone->color : old('color') }}">
                </div>
                <div class="mb-3 col-sm-6 pb-2">
                  <label class="form-label" for="storage_capacity">Storage Capacity</label>
                  <select class="form-control" name="storage_capacity" id="storage_capacity">
                  ...
                  <div class="mb-3 col-sm-6 pb-2">
                     ...
                     </label>                     <input class="form-control" type="text" name="operating_system" id="operating_system" value="{{ old('operating_system') }}">
                  </div>
                  <div class="mb-3 col-sm-6 pb-2">
                     ...
                     </label>                     <input class="form-control" type="number" min="0" max="100" step="1" name="battery_health" id="battery_health" value="{{ old('battery_health') }}">
                  </div>
                  <div class="mb-3 col-sm-6 pb-2">
...
<option value="Bluetooth" {{ (isset($phone) && $phone->connectivity_issues == 'Bluetooth') || old('connectivity_issues') == 'Bluetooth' ? 'selected' : '' }}>Bluetooth</option>
                  ...
                  <div class="mb-3 py-2">
                     ...
                     <textarea class="form-control" rows="6" name="description" id="unp-product-description"></textarea>
                  </div>
                  <div class="mb-3 pb-2">
                    <label class="form-label" for="unp-product-files">Product Thumbnail</label>
                    <input class="form-control" type="file" name="main_image" id="unp-product-files" accept="image/*">
                  ...
                  <div class="mb-3 pb-2">
                    <label class="form-label" for="additional_images">Upload More Images</label>
                    <input class="form-control" multiple type="file" name="additional_images" id="additional_images">
                    <div class="form-text">Maximum file size is 10MB</div>
