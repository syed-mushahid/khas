...
<!-- User Details Modal -->
<div class="modal-lg modal fade " id="userDetailsModal" tabindex="-1" role="dialog" aria-labelledby="userDetailsModalLabel" aria-hidden="true">
...
<div class="modal modal-lg fade" id="userEditModal" tabindex="-1" role="dialog" aria-labelledby="userEditModalLabel" aria-hidden="true">
...
function showUserDetails(user) {
  ...
  var accountStatus="<span class='text-success'>Active</span>";
    ...
    document.getElementById('user-last-login').innerText = ReadableTime(user.last_login);
